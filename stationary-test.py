...
class Topology(Thread):
    ...
    def run(self):
        ...
        self.stations.append(net.addStation('sta1', min_v=1, max_v=2, position='10,10,0'))
        self.stations.append(net.addStation('sta2', min_v=1, max_v=2, position='50,10,0'))
        self.stations.append(net.addStation('sta3', min_v=1, max_v=2, position='90,10,0'))
        ...
        for i in range(len(self.stations)):
            self.stations[i].cmd("~/mininet-wifi/examples/sdn-vanet/run.sh {} {} test &".format(i + 1, len(self.stations)))
